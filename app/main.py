...
from .routers import forms, uploads, applications
from sqlalchemy.orm import Session
from .utils import get_db, reference_keys
import os, json
...
def check_and_run_pipeline():
    ...
    try:
        ...
        form, application = (
            ...
            db.query(Application).filter(Application.form_id == row.form_id).first(),
        )
        ...
        if form and application:
            ...
            user_pdf_path_abs = os.path.join(folder_dir, "uploads", row.filename)
            ...
            result = run_pipeline(reference_keys, reference_pdf_path_abs, user_pdf_path_abs, user_json_dict)
